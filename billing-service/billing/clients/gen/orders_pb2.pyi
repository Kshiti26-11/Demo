...
class OrderSummary(_message.Message):
    __slots__ = ("customer_name", "total_price", "order_id", "status", "customer", "total", "shipping_eta")
    ...
    total: Money
    shipping_eta: str
    def __init__(self, customer_name: _Optional[str] = ..., total_price: _Optional[float] = ..., order_id: _Optional[str] = ..., status: _Optional[_Union[OrderStatus, str]] = ..., customer: _Optional[_Union[Customer, _Mapping]] = ..., total: _Optional[_Union[Money, _Mapping]] = ..., shipping_eta: _Optional[str] = ...) -> None: ...
