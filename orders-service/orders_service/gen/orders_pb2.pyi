...
class OrderSummary(_message.Message):
    __slots__ = ("order_id", "status", "customer", "total", "shipping_eta")
    ORDER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    total: Money
    shipping_eta: str
    def __init__(self, order_id: _Optional[str] = ..., status: _Optional[_Union[OrderStatus, str]] = ..., customer: _Optional[_Union[Customer, _Mapping]] = ..., total: _Optional[_Union[Money, _Mapping]] = ..., shipping_eta: _Optional[str] = ...) -> None: ...
